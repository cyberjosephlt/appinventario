...
import com.unab.edu.co.grupo69.appinventario.Service.EntidadService;
...
public class EntidadController {
    ...
    @PostMapping("/create")
    public ResponseEntity<Message> save(@RequestBody Entidad entidad){
    ...
    public ResponseEntity<Message> deleteByidEntity(@PathVariable String idEntidad){
        
        Message message=entidadservice.deleteById(idEntidad);
    ...
    public List<Entidad> findAll(){
            ...
            return (List<Entidad>) entidadservice.findAll();
    ...
    @PutMapping("/update")
    public ResponseEntity<Message> update(@RequestBody Entidad entidad){
        ...
        try {
            ...
            if(entidad.getRazonSocial()==null){
                ...
                Message message=entidadservice.update(entidad);
